...
public class Update_student implements ActionListener {
    ...
    public Update_student() {
        ...
        heading_label.setText("UPDATE STUDENT");
    ...
    public void UpdateDB() {
        ...
        try {
            ...
            String query = "UPDATE `students-register` SET `First-name`='" + fname + "', `Surname`='" + surname
                    + "', `Email`='" + email + "', `Phone-number`='" + pnumber + "', `Year`='" + year
                    + "', `Semester`='" + semester + "' WHERE  `Reg_no`='" + regno + "'";
