...
public class Users extends JPanel implements MouseListener, ActionListener {
    ...
    public Users() {
        ...
        ImageIcon heading_icon = new ImageIcon(new ImageIcon("src/icons/conference-call-24.png").getImage()
                .getScaledInstance(48, 48, Image.SCALE_DEFAULT));

        JLabel heading_label = new JLabel();
        heading_label.setText("USERS");
        ...
        ImageIcon icon_1 = new ImageIcon(new ImageIcon("src/icons/view-details-48.png").getImage().getScaledInstance(48,
                48, Image.SCALE_DEFAULT));
        label_1 = new JLabel();
        label_1.setText("VIEW STUDENTS");
        ...
        ImageIcon icon_2 = new ImageIcon(new ImageIcon("src/icons/view-details-48.png").getImage().getScaledInstance(48,
                48, Image.SCALE_DEFAULT));
        label_2 = new JLabel();
        label_2.setText("VIEW ACCOUNTANTS");
        ...
        ImageIcon icon_3 = new ImageIcon(new ImageIcon("src/icons/remove-user-48.png").getImage().getScaledInstance(48,
                48, Image.SCALE_DEFAULT));
        label_3 = new JLabel();
        label_3.setText("DELETE ACCOUNTANT");
        ...
        label_4 = new JLabel();
        label_4.setText("UPDATE ACCOUNTANT");
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == label_1) {
            ...
            new view_Accountants();
        } else if (e.getSource() == label_3) {
            new Delete_Accountant();
        } else if (e.getSource() == label_4) {
            new Update_Accountant();
        }
