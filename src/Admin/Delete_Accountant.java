...
public class Delete_Accountant implements ActionListener {
    ...
    public Delete_Accountant() {
        ...
        label_icon.setText("DELETE ACCOUNTANT");
    ...
    public void delete_db() {
        try {
            String Uname = label.getText();

            String query = "DELETE FROM `accountants-register` WHERE `Username` = '" + Uname + "'";
            ...
            if (x > 0) {
                ...
                JOptionPane.showMessageDialog(btn_delete, "Failed to Delete");
            }
