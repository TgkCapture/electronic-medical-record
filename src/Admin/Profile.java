...
public class Profile extends JPanel {
        ...
        public Profile() {
                ...
                ImageIcon heading_icon = new ImageIcon(new ImageIcon("src/icons/guest-48.png").getImage()
                ...
                Box.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Profile",
