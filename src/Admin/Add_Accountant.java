...
public class Add_Accountant implements ActionListener {
    ...
    public Add_Accountant() {
        ...
        ImageIcon title_icon = new ImageIcon("src/icons/add-user-32.png");
        ...
        heading_label.setText("ADD ACCOUNTANT");
        ...
        field_4.setPreferredSize(new Dimension(210, 20));
        field_4.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, Color.black));
        field_4.setBackground(null);
        field_panel4.add(field_4);
        ...
        Add_btn.setBackground(Color.decode("#123456"));
    ...
    public void add() {
        ...
        try {
            ...
            String pnumber = field_3.getText();
            String semester = field4.getText();
            String year = field_4.getText();

            String query = "INSERT INTO `students-register` (`reg_no`, `first-name`, `surname`, `email`, `phone-number`, `year`, `semester`) VALUES ('"
                    + regno + "','" + fname + "', '" + surname + "', '" + email + "', '" + pnumber + "', '" + semester
                    + "', '" + year + "')";
